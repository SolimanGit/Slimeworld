...
public class Weapon extends Sprite{
	...
	public boolean destroyed, isDestroyed;
	
	public Weapon(World world, TiledMap map, Rectangle bounds, PlayScreen screen) {
		this.screen = screen;
		destroyed = false;
		isDestroyed = false;
		...
		this.texture = new Texture("BOULE_item.png");
